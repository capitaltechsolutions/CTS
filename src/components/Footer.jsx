      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li className="hover:text-blue-400 transition-colors cursor-pointer">Diseño Web</li>
              <li className="hover:text-blue-400 transition-colors cursor-pointer">Tienda Online</li>
              <li className="hover:text-blue-400 transition-colors cursor-pointer">Marketing Digital</li>
              <li className="hover:text-blue-400 transition-colors cursor-pointer">SEO & Analytics</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-center gap-2">
                <span>📧</span>
                <a href="mailto:contacto@clsdigital.com" className="hover:text-blue-400 transition-colors">
                  contacto@clsdigital.com
                </a>
              </li>
              <li className="flex items-center gap-2">
                <span>📱</span>
